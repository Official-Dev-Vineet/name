 ...
 if(isset($_POST['btn_save2']))
  {
    ...
    $tempimgname1= $_FILES['video']['tmp_name'];
    move_uploaded_file($tempimgname1,"../../image/$video");
    
    $brochure = $_FILES['brochure']['name'];
    $tempimgname6 = $_FILES['brochure']['tmp_name'];
    move_uploaded_file($tempimgname6,"../../image/$brochure");
    
    $Product = $_FILES['product']['name'];
    $tempimgname5= $_FILES['product']['tmp_name'];
    move_uploaded_file($tempimgname5,"../../image/$Product");
  ...
  $result = mysqli_query($sql_con, "INSERT INTO `property`(`RegistrationId`, `Property_Name`, `Property_Type`, `Property_Address`, `Property_Overview`,`Available_Units`,`Towers`,`Floors`,`Furnishing`,`Project_Area`,`Launch_Year`,`Open_Space`,`Approved_by`,
`Exclusive_Amenities`,`Brochure`, `Video`,`Property_Image`,`Property_Image1`,`Property_Image2`,`Property_Image3`,`Top_Property`,`Amount`) VALUES ('$id','$name','$type','$address','$overview','$unit','$towers','$floors','$furnishing','$area','$year','$space','$approved','$amenities','$brochure','$video','$Product','$Product1','$Product2','$Product3','$top','$amount')");
...
<body onload="Init ();">
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Properties Master</h4>
  ...
  <div class="form-group has-error">
   ...
   <div class="form-group has-error">
    <label for="time1">Top Project</label>
