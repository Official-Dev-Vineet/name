...
<body onload="Init ();">
  ...
  <div class="container-scroller">
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">University Course Information</h4>
    ...
    <tbody>
        ...
        <?php
$result = mysqli_query($sql_con,"SELECT * FROM `university` where RegistrationId='$id'");
$count = 0;
while($row = mysqli_fetch_array($result))
{
    $sno = $row['Sno'];
  $Inquiryid = $row["RegistrationId"];
  $InquiryName = $row["DegreeName"];
  $State = $row["DeggreCourse"];
  $Country = $row["Image"];
  ?>
   <tr>
    ...
    <td><?php echo $Country;?></td>
     <td><button type="button" class="btn btn-info" data-toggle="modal" onclick="document.getElementById('sno').value = '<?php echo $sno; ?>';document.getElementById('Register').value = '<?php echo $Inquiryid; ?>';document.getElementById('Location').value = '<?php echo $InquiryName; ?>';document.getElementById('Specifications').value = '<?php echo $State; ?>';document.getElementById('Country').value = '<?php echo $Country; ?>';" data-target="#myMod">Details</button></td>
    </tr>
  <?php
}
       ?>
...
<form method="post" enctype="multipart/form-data">
  ...
  <div class="form-group has-error">
    <label for="time1">Degree Name</label>
