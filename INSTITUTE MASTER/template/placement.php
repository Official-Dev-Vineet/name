...
if(isset($_POST['btn_team']))
  ...
  $result = mysqli_query($sql_con, "INSERT INTO `placement` (`RegistrationId`, `Name`,`CompanyName`,`Image`) VALUES ('$id','$team_name','$team_designation','$team_image')");
  }
    ...
    <!-- partial -->
      <div class="main-panel">        
        <div class="content-wrapper">
            <a href="placement-update.php?user1=<?php echo $id; ?>" class="btn btn-info" style="margin-bottom: 10px;">Update</a>
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Placement Master</h4>
