 ...
 if(isset($_POST['update']))
  {
   ...
   if(empty($Country))
   {
 $result = mysqli_query($sql_con, "UPDATE `placement` SET `Name`='$Location',`CompanyName`='$state' WHERE Sno='$sno'");
 }
 else
 {
     $result = mysqli_query($sql_con, "UPDATE `placement` SET `Name`='$Location',`CompanyName`='$state',`Image`='$Country' WHERE Sno='$sno'");
 }
  }
 if(isset($_POST['delete']))
{
 $sno = isset($_POST['sno'])?$_POST['sno']:null;
$result1 = mysqli_query($sql_con,"DELETE FROM `placement` WHERE Sno='$sno'");
...
<body>
  ...
  <!-- partial:partials/_navbar.html -->
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Placement Information</h4>
    ...
    <tbody>
        ...
        <?php
$result = mysqli_query($sql_con,"SELECT * FROM `placement` where RegistrationId='$id'");
$count = 0;
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Placement Information</h4>
...
<form method="post" enctype="multipart/form-data">
  ...
  <div class="form-group has-error">
   ...
   <div class="form-group has-error">
    <label for="time1">Company Name</label>
