...
if(isset($_POST['btn_testimonial']))
  ...
  $result = mysqli_query($sql_con, "INSERT INTO `testimonial` (`RegistrationId`, `Name`,`Designation`,`Name`) VALUES ('$id','$testimonial_name','$testimonial_description','$testimonial_image')");
  }
