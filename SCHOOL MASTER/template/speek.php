...
if(isset($_POST['btn_management']))
  ...
  $result = mysqli_query($sql_con, "INSERT INTO `management` (`RegistrationId`, `Name`,`Designation`,`Description`,`Image`) VALUES ('$id','$manag_name','$manag_desig','$manag_desc','$manag_img')");
  }
    ...
    <!-- partial -->
      <div class="main-panel">        
        <div class="content-wrapper">
             <a href="speek-update.php?user1=<?php echo $id; ?>" class="btn btn-info" style="margin-bottom: 10px;">Update</a>
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Management Speek Master</h4>
