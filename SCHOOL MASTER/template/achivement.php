...
if(isset($_POST['btn_achivement']))
  ...
  $result = mysqli_query($sql_con, "INSERT INTO `achivement` (`RegistrationId`, `Name`,`Image`) VALUES ('$id','$achivement_name','$achivement_img')");
  }
...
<body>
    ...
    <!-- partial -->
      <div class="main-panel">        
        <div class="content-wrapper">
            <a href="achivement-update.php?user1=<?php echo $id; ?>" class="btn btn-info" style="margin-bottom: 10px;">Update</a>
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Achivement Master</h4>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="file" name="achivement_img" class="form-control"  id="image" />
  </div> 
