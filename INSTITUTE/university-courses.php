        ...
        <ul class="navbar-nav navbar-light">
            ...
            <li class="nav-item dmenu dropdown">
                ...
                <div class="dropdown-menu sm-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="university-courses.php?user6=<?php echo $user; ?>&name=<?php echo $name; ?>">university Courses</a>
                </div>
            </li>
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg'); ">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0">University Courses</h2>
   ...
   -webkit-box-orient: vertical;
    ...
    <div class="site-section">
        <div class="container">
            <div class="row">
                <?php
                  $course = mysqli_query($sql_con, "SELECT * FROM university where RegistrationId='$user'");
