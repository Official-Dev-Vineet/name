...
$blog = mysqli_query($sql_con, "SELECT * FROM blog where RegistrationId='$user' and Sno='$id'");
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0"><?php echo $blog_name; ?></h2>
            </div>
          </div>
        </div>
      </div> 
                ...
                <div class="col-lg-8 m-15px-tb">
                    <article class="article">
                        <div class="article-img">
                            <img src="../image/<?php echo $blog_image; ?>" title="" alt="" style="width: 100%;">
                        </div>
                        <div class="article-title">
                            <h6><a href="#"><?php echo $blog_date; ?>/ <?php echo $blog_time; ?></a></h6>
                            <h2><?php echo $blog_name; ?></h2>
                            
                        </div>
                        <div class="article-content">
                            <p style="color: black;"><?php echo $blog_short; ?></p>
                            <p style="color: black;"><?php echo $blog_long; ?></p>
                ...
                <div class="col-lg-4 m-15px-tb blog-aside">
                    ...
                    <div class="widget widget-latest-post">
                        ...
                        <div class="widget-body">
                            <?php
                    $blog = mysqli_query($sql_con, "SELECT * FROM blog where RegistrationId='$user' limit 5");
                  while($alle = mysqli_fetch_array($blog))
                  {
                      $blog_name = $alle['Title'];
                    $blog_date = $alle['Date'];
                    $blog_time = $alle['Time'];
                    $blog_short = $alle['Short_detail'];
                    $blog_image = $alle['Image'];
                    $blog_sno = $alle['Sno'];
                            ?>
                            <div class="latest-post-aside media">
                                <div class="lpa-left media-body">
                                    <div class="lpa-title">
                                        <h5><a href="blog-detail.php?id=<?php echo $blog_sno; ?>&user6=<?php echo $user; ?>&name=<?php echo $name; ?>"><?php echo $blog_name; ?></a></h5>
                                    </div>
                                    <div class="lpa-meta">
                                        <a class="name" href="blog-detail.php?id=<?php echo $blog_sno; ?>&user6=<?php echo $user; ?>&name=<?php echo $name; ?>">
                                           <?php echo $blog_date; ?> 
                                        </a>
                                        <a class="date" href="blog-detail.php?id=<?php echo $blog_sno; ?>&user6=<?php echo $user; ?>&name=<?php echo $name; ?>">
                                            <?php echo $blog_time; ?>
                                        </a>
                                    </div>
                                </div>
                                <div class="lpa-right">
                                    <a href="course_single.php?id=<?php echo $sno; ?>&user6=<?php echo $user; ?>&name=<?php echo $name; ?>">
                                        <img src="../image/<?php echo $blog_image; ?>" title="" alt="">
                                    </a>
                                </div>
                            </div>
                            <?php
                  ...
                  ?>
                    ...
                    <div class="widget widget-latest-post">
                        ...
                        <div class="widget-body">
                            <?php
                            $all = mysqli_query($sql_con, "SELECT * FROM course where RegistrationId='$user' limit 5");
