	...
	<div class="wrapper" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset; background: #002147;">
		<div class="form">
			...
			<form method="post">
				...
				<div class="form-group" style="margin: 7px;">
					<textarea id="email" type="email" placeholder="Enter your Message" class="form-control" name="message" required></textarea>
				</div>
				<button id="submit" type="submit" name="send" style="background: #002147;">Send</button>
			</form>
			</div>
		</div>
	</div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-5">
            <form action="" class="d-flex">
              ...
              <button class="btn btn-primary rounded" type="button" style="height: 40px;">Send</button>
            </form>
          </div>
        </div>
      </div>
