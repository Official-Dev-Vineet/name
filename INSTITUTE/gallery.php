...
?>
   ...
   <center> <h3 style="margin-top: 30px;font-weight: bolder; background-color: #002147; color: white; width: 50%;"><?php echo $gain; ?></h3> </center>
    <div>
        <?php 
         $resuls2 = mysqli_query($sql_con,"SELECT * FROM `gallery` where title='$gain'");
