   ...
   <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <div class="page-header text-center" style="background-image: url('assets/images/our product.jpg')">
        		<div class="container">
        			<h1 class="page-title" style="color: white; font-weight: bolder; font-size: 44px; text-transform: uppercase;">Contact Us</h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
                ...
                <div class="container">
                	<div class="row">
                		<div class="col-lg-6 mb-2 mb-lg-0">
                		    <div style="background-color: #db7093; padding: 20px;">
                		...
                		<div class="col-lg-6" style="padding-bottom: 30px;">
                			...
                			<center>	<button type="submit" align="center" class="btn btn-minwidth-sm" style="background: #db7093; color: white; float: center;">
                					<span>SUBMIT</span>
