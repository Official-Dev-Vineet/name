   ...
   <div class="page-wrapper">
        ...
        <main class="main">
          <div class="page-header text-center" style="background-image: url('assets/images/our product.jpg')">
        		<div class="container">
        			<h1 class="page-title" style="color: white; font-weight: bolder;">About Us</h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 mb-3 mb-lg-0">
                                <h2 class="title" style="font-family: Amasis MT Pro; margin-bottom: 0px; font-size: 28px; font-weight: bold; margin-bottom: 15px;">Who We Are</h2><!-- End .title -->
                                <p class="lead mb-3" style="font-size: 14px; color: black; text-align: justify;"><?php echo $about; ?></p><!-- End .lead text-primary -->
                               <p style="font-size: 18px; color: black; font-weight: bolder; font-family: Amasis MT Pro;">Bussiness: <?php echo $bussines; ?></p>
                               <p style="font-size: 18px; color: black; font-weight: bolder; font-family: Amasis MT Pro;">Year of Establishment: <?php echo $establishment; ?></p>
                               <p style="font-size: 18px; color: black; font-weight: bolder; font-family: Amasis MT Pro;">No of Employee: <?php echo $employee; ?></p>
                            </div><!-- End .col-lg-5 -->

                            <div class="col-lg-5 offset-lg-1">
                                <div class="about-images">
                                    <img src="../image/<?php echo $images; ?>" alt="" class="about-img-front">
...
<div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-lg-6 mb-3 mb-lg-0">
                            <div style="box-shadow: rgba(6, 24, 44, 0.4) 0px 0px 0px 2px, rgba(6, 24, 44, 0.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset; padding: 20px;">
                            <h2 class="title" style="font-family: Amasis MT Pro; margin-bottom: 0px; font-size: 28px; font-weight: bold;">Our Vision</h2><!-- End .title -->
                            <p style="font-size: 13px; color: black;"><?php echo $vission; ?> </p>
                            </div>
                        </div><!-- End .col-lg-6 -->
                        
                    <div class="col-lg-6">
                        <div style="box-shadow: rgba(6, 24, 44, 0.4) 0px 0px 0px 2px, rgba(6, 24, 44, 0.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset; padding: 20px;">
                            <h2 class="title" style="font-family: Amasis MT Pro; margin-bottom: 0px; font-size: 28px; font-weight: bold;">Our Mission</h2><!-- End .title -->
                            <p style="font-size: 13px; color: black;"><?php echo $mission; ?></p>
                        </div>
                        </div><!-- End .col-lg-6 -->
                    </div><!-- End .row -->
