...
$result = mysqli_query($sql_con, "SELECT * FROM vendors where RegistrationId='$user' and Sno='$id'");
while($row = mysqli_fetch_array($result))
{
    $productname = $row['Vendors_Name'];
    $productrate = $row['Vendors_Amount'];
    $productdescription = $row['Vendor_Address'];
    $image1 = $row['Vendors_Image'];
    $image2 = $row['Vendors_Picture'];
    $image3 = $row['Vendors_Pic'];
    $image4 = $row['Vendors_Pictu'];
    $image5 = $row['Vendors_Img'];
    $productcatehory = $row['Vendors_Type'];
}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="product-details">
                                    ...
                                    <a href="" class="btn btn-primary" style="background-color: #db7093; color: white; font-family: Amasis MT Pro; margin-bottom: 10px; font-size: 16px; font-weight: bold;">Price :-  Rs. <?php echo $productrate; ?>/-</a>
                                    <a href="" class="btn btn-secondary" style="background-color: #db7093; color: white; font-family: Amasis MT Pro; margin-bottom: 10px; font-size: 16px; font-weight: bold;">Address:-  Rs. <?php echo $productdescription; ?>/-</a>
