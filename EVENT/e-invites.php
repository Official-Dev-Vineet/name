   ...
   <div class="page-wrapper">
        ...
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/our product.jpg')">
        		<div class="container">
        			<h1 class="page-title" style="color: white; font-weight: bolder;">E-Invites</h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
                		...
                		<div class="col-lg-12">
                            ...
                            <div class="products mb-3">
                                <div class="row justify-content-center">
                                    ...
                                    <?php
         $Product = mysqli_query($sql_con,"SELECT * FROM e_invites where RegistrationId='$user'");
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px; background-color: #db7093; color: white;">
                                            <figure class="product-media" >
                                                ...
                                                <a href="../image/<?php echo $Cate['CardImage']; ?>" target="_blank">
                                                    <img src="../image/<?php echo $Cate['CardImage']; ?>" alt="Product image" class="product-image">
                                                </a>
                                            ...
                                            <div class="product-body" style="background-color: #db7093; color: white;">
                                                ...
                                                <h3 class="product-title" style="color: white;"><a href="#"><?php echo $Cate['CardName']; ?></a></h3><!-- End .product-title -->
                                                <!-- End .product-price -->
