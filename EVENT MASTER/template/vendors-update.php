...
if(empty($Phone))
{
 $result = mysqli_query($sql_con, "UPDATE `vendors` SET `Vendors_Type`='$Register',`Vendors_Name`='$Location',`Vendor_Address`='$state',`Vendors_Amount`='$Country',`Vendors_Picture`='$picture1',`Vendors_Pic`='$picture2',`Vendors_Pictu`='$picture3',`Vendors_Img`='$picture4' WHERE Sno='$sno'");  
 }
 elseif(empty($picture1))
 {
   $result = mysqli_query($sql_con, "UPDATE `vendors` SET `Vendors_Type`='$Register',`Vendors_Name`='$Location',`Vendor_Address`='$state',`Vendors_Amount`='$Country',`Vendors_Image`='$Phone',`Vendors_Pic`='$picture2',`Vendors_Pictu`='$picture3',`Vendors_Img`='$picture4' WHERE Sno='$sno'");    
 }
 elseif(empty($picture2))
 {
     $result = mysqli_query($sql_con, "UPDATE `vendors` SET `Vendors_Type`='$Register',`Vendors_Name`='$Location',`Vendor_Address`='$state',`Vendors_Amount`='$Country',`Vendors_Image`='$Phone',`Vendors_Picture`='$picture1',`Vendors_Pictu`='$picture3',`Vendors_Img`='$picture4' WHERE Sno='$sno'");  
 }
 elseif(empty($picture3))
 {
    $result = mysqli_query($sql_con, "UPDATE `vedors` SET `Vendors_Type`='$Register',`Vendors_Name`='$Location',`Vendor_Address`='$state',`Vendors_Amount`='$Country',`Vendors_Image`='$Phone',`Vendors_Picture`='$picture1',`Vendors_Pic`='$picture2',`Vendors_Img`='$picture4' WHERE Sno='$sno'");   
 }
 elseif(empty($picture4))
 {
     $result = mysqli_query($sql_con, "UPDATE `vendors` SET `Vendors_Type`='$Register',`Vendors_Name`='$Location',`Vendor_Address`='$state',`Vendors_Amount`='$Country',`Vendors_Non`='$Email_Id',`Vendors_Image`='$Phone',`Vendors_Picture`='$picture1',`Vendors_Pic`='$picture2',`Vendors_Pictu`='$picture3' WHERE Sno='$sno'");  
 }
 else
 {
   $result = mysqli_query($sql_con, "UPDATE `vendors` SET `Vendors_Type`='$Register',`Vendors_Name`='$Location',`Vendor_Address`='$state',`Vendors_Amount`='$Country',`Vendors_Image`='$Phone',`Vendors_Picture`='$picture1',`Vendors_Pic`='$picture2',`Vendors_Pictu`='$picture3',`Vendors_Img`='$picture4' WHERE Sno='$sno'");  
 }
  }
...
{
 $sno = isset($_POST['sno'])?$_POST['sno']:null;
$result1 = mysqli_query($sql_con,"DELETE FROM `vendors` WHERE Sno='$sno'");
  ...
  <div class="container-scroller">
    ...
    <thead>
      <tr>
        ...
        <th>Vendors Type</th>
        <th>Vendors Name</th>
        <th>Vendors Address</th>
        <th>Vendors Amount</th>
        <th>Picture</th>
        <th>Picture</th>
        <th>Picture</th>
        <th>Picture</th>
    ...
    <tbody>
        ...
        <?php
$result = mysqli_query($sql_con,"SELECT * FROM `vendors` where RegistrationId='$id'");
$count = 0;
while($row = mysqli_fetch_array($result))
{
    $sno = $row['Sno'];
  $Inquiryid = $row["Vendors_Type"];
  $InquiryName = $row["Vendors_Name"];
  $State = $row["Vendor_Address"];
  $Country = $row["Vendors_Amount"];
   $InquiryCourse = $row["Vendors_Image"];
   $Venues_Picture = $row["Vendors_Picture"];
   $Venues_Pic = $row["Vendors_Pic"];
   $Venues_Pictu = $row["Vendors_Pictu"];
   $Venues_Img = $row["Vendors_Img"];
  ?>
   <tr>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Vendors Information</h4>
