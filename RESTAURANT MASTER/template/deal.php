...
if(isset($_POST['btn_deal']))
  ...
  $result = mysqli_query($sql_con, "INSERT INTO `deal` (`RegistrationId`, `Image`) VALUES ('$id','$deal')");
  }
    ...
    <!-- partial -->
      <div class="main-panel">        
        <div class="content-wrapper">
            <a href="deal-update.php?user1=<?php echo $id; ?>" class="btn btn-info" style="margin-bottom: 10px;">Update</a>
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Deals of the Day Master</h4>
