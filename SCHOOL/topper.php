  ...
  <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg');">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-12">
              <h2 class="mb-0" style="color: white; text-align: center; margin-bottom: 5px; font-family: Amasis MT Pro; font-weight: bolder; text-transform: uppercase;">Toppers</h2>
...
<div class="section style-1" style="background: #f4f0ec;">
      <div class="container">
         
        <div class="row">
            <?php
            $gallery = mysqli_query($sql_con, "SELECT * FROM topper where RegistrationId='$user'");
          ...
          <div class="col-lg-3" style="margin-top: 20px;">
              <div class="zoom" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px; margin-bottom: 20px; padding-bottom: 10px; background: #003153;">
                  <a href="../image/<?php echo $image; ?>" target="_blank">
                  <img src="../image/<?php echo $image; ?>" class="img-fluid img-thumbnail" style="width: 96%; height: 200px; margin: 5px;">
                  <h5 style="text-align: center; color: white; font-weight: bolder;"><?php echo $nam; ?> / <?php echo $clas; ?></h5>
                  <h6 style="color: white; margin-left: 10px; font-weight: bolder;">Position/ Percentage: <?php echo $position; ?>/ <?php echo $percentage; ?></h6>
