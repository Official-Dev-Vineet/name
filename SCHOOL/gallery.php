...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300" style="background: #f2f3f4;">
...
<div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg'); ">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-12">
              <h2 class="mb-0" style="color: white; text-align: center; margin-bottom: 5px; font-family: Amasis MT Pro; font-weight: bolder; text-transform: uppercase;">Our Gallery</h2>
            </div>
          </div>
        </div>
      </div> 
...
<div class="container">
 <?php
    $resuls = mysqli_query($sql_con,"SELECT any_value(Title) as title FROM `gallery` where RegistrationId='$user' group by Title");
...
?>
   ...
   <center> <h3 style="margin-top: 30px;font-weight: bolder; background-color: #002147; color: white; width: 100%;"><?php echo $gain; ?></h3> </center>
    <div>
        <?php 
         $resuls2 = mysqli_query($sql_con,"SELECT * FROM `gallery` where title='$gain' and RegistrationId='$user'");

while($row2=mysqli_fetch_array($resuls2))
{
    $gives = $row2['Image'];
    ?>

      <a href="../image/<?php echo $gives; ?>" target="_blank"><img src="../image/<?php echo $gives; ?>" class="img-thumbnail"  style="height: 200px; width: 250px; margin-bottom: 20px; margin-left: 20px;"></a>
