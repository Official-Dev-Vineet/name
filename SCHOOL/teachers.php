  ...
  <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg');">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-12">
              <h2 class="mb-0" style="color: white; text-align: center; margin-bottom: 5px; font-family: Amasis MT Pro; font-weight: bolder; text-transform: uppercase;">Our Teachers</h2>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="team-item" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset; background: #003153;">
