  ...
  <body>
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <a href="appanageflix.php" class="navbar-brand"> <img src="images/logo.png" alt=""> </a>
            <span class="navbar-text">AppanageFlix</span>
            ...
            <ul class="navbar-nav">
              ...
              echo"<li class='nav-item'> <a href='account.php' class='nav-link'>Account</a> </li>
                  ...
                  <br><br><br>";
                  include 'dbh.php';
                  $quer = "SELECT * FROM user1  ";
                  $quer2 = "SELECT * FROM movies WHERE mid in (SELECT mid from user1 ) ";
