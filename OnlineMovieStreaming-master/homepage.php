  ...
  <body style="background-color: black;">
    <header>
        ...
        <nav class="navbar navbar-expand-md" style="background-color: black;">
            ...
            <span class="navbar-text" style="color: white;">AppanageFlix</span>
            ...
            <ul class="navbar-nav">
              ...
              echo"<h1 style='color:white;position:sticky;'>WELCOME </h1><b style = 'color: white;font-size: 25px'><i> ".ucwords($rel['name'])." !</i></b>
                ...
                <div class='jumbotron' style='margin-top:15px;padding-top:30px;padding-bottom:30px; background-color: black;'>
                <div class='row'>
                  <div class='col'>
