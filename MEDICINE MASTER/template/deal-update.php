...
include 'connection.php';
 ...
 $result = mysqli_query($sql_con, "UPDATE `deal` SET `Image`='$Location' WHERE Sno='$sno'");
 }
 if(isset($_POST['delete']))
{
 $sno = isset($_POST['sno'])?$_POST['sno']:null;
$result1 = mysqli_query($sql_con,"DELETE FROM `deal` WHERE Sno='$sno'");
...
<body>
  <div class="container-scroller">
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Deal Information</h4>
    ...
    <tbody>
        ...
        <?php
$result = mysqli_query($sql_con,"SELECT * FROM `deal` where RegistrationId='$id'");
$count = 0;
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Deal Information</h4>
