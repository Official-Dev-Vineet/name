...
if(isset($_POST['btn_client']))
  ...
  $result = mysqli_query($sql_con, "INSERT INTO `client` (`RegistrationId`, `Image`) VALUES ('$id','$client_image')");
  }
    ...
    <!-- partial -->
      <div class="main-panel">        
        <div class="content-wrapper">
            <a href="client-update.php?user1=<?php echo $id; ?>" class="btn btn-info" style="margin-bottom: 10px;">Update</a>
          <div class="row">
