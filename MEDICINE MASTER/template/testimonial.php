...
if(isset($_POST['btn_testimonial']))
  ...
  $result = mysqli_query($sql_con, "INSERT INTO `course` (`RegistrationId`, `Course_Category`,`Course_Name`,`Course_Duration`,`Course_Rate`,`Course_Short`,`Course_Long`) VALUES ('$id','$testimonial_name','$testimonial_description','$testimonial_image')");
  }
