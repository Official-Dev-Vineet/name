...
if(isset($_POST['blog_btn']))
  ...
  $result = mysqli_query($sql_con, "INSERT INTO `doctor` (`RegistrationId`, `Doctor_Name`, `Doctor_Department`,`Doctor_Degree`,`Shortdetail`,`MobileNo`, `EmailId`, `Doctor_Image`) VALUES ('$id','$blog_title','$blog_date','$blog_time','$long_detail','$mobile','$short_detail','$blog_img')");
  }
...
<body>
    ...
    <!-- partial -->
      <div class="main-panel">        
        <div class="content-wrapper">
            <a href="doctor-update.php?user1=<?php echo $id; ?>" class="btn btn-info" style="margin-bottom: 10px;">Update</a>
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Doctor Master</h4>
  ...
  <div class="form-group">
    <label for="Inputselect">Doctor Name </label>
    
    <input type="text" name="blog_title" class="form-control"  />
  </div> 
  
  <div class="form-group">
    <label for="Inputselect">Doctor Department </label>
    
    <input type="text" name="blog_date" class="form-control"  />
  </div> 
  
  <div class="form-group">
    <label for="Inputselect">Doctor Degree </label>
    
    <input type="text" name="blog_time" class="form-control"  />
  </div> 
  <div class="form-group">
    <label for="Inputselect">Mobile No </label>
    
    <input type="text" name="mobile" class="form-control"  />
  </div> 
  
  <div class="form-group">
    <label for="Inputselect">Email Id </label>
    
    <input type="text" name="short_detail" class="form-control" />
  </div> 
  
  <div class="form-group">
    <label for="Inputselect">About Doctor </label>
