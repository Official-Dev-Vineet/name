...
if(empty($Phone_No))
{
 $result = mysqli_query($sql_con, "UPDATE `services` SET `Name`='$Register',`Short_Detail`='$Country',`Long_Detail`='$Email_Id' WHERE Sno='$sno'");
 }
 else
 {
   $result = mysqli_query($sql_con, "UPDATE `services` SET `Name`='$Register',`Short_Detail`='$Country',`Long_Detail`='$Email_Id',`Image`='$Phone_No' WHERE Sno='$sno'");  
 }
  }
...
{
 $sno = isset($_POST['sno'])?$_POST['sno']:null;
$result1 = mysqli_query($sql_con,"DELETE FROM `services` WHERE Sno='$sno'");
...
<body>
  <div class="container-scroller">
    ...
    <tbody>
        ...
        <?php
$result = mysqli_query($sql_con,"SELECT * FROM `services` where RegistrationId='$id'");
$count = 0;
...
<form method="post" enctype="multipart/form-data">
  ...
  <div class="form-group has-warning">
    <label for="day1">Service Name</label>
