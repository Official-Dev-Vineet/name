...
if(isset($_POST['blog_btn']))
  ...
  $result = mysqli_query($sql_con, "INSERT INTO `department` (`RegistrationId`, `DepartmentName`, `ShortDetail`,`LongDetail`,`Image`) VALUES ('$id','$blog_title','$long_detail','$short_detail','$blog_img')");
  }
...
<body>
    ...
    <!-- partial -->
      <div class="main-panel">        
        <div class="content-wrapper">
            <a href="department-update.php?user1=<?php echo $id; ?>" class="btn btn-info" style="margin-bottom: 10px;">Update</a>
          <div class="row">
  ...
  <div class="form-group">
    <label for="Inputselect">Department Name </label>
  ...
  <div class="form-group">
    ...
    <textarea type="text" name="short_detail" class="form-control" ></textarea>
  </div> 
  
  <div class="form-group">
    <label for="Inputselect">Long Detail </label>
    
    <textarea type="text" name="long_detail" class="form-control" ></textarea>
  </div> 
