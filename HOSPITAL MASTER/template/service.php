...
if(isset($_POST['blog_btn']))
  ...
  $result = mysqli_query($sql_con, "INSERT INTO `services` (`RegistrationId`, `Name`, `Short_Detail`,`Long_Detail`,`Image`) VALUES ('$id','$blog_title','$long_detail','$short_detail','$blog_img')");
  }
...
<body>
    ...
    <!-- partial -->
      <div class="main-panel">        
        <div class="content-wrapper">
            <a href="service-update.php?user1=<?php echo $id; ?>" class="btn btn-info" style="margin-bottom: 10px;">Update</a>
          <div class="row">
  ...
  <div class="form-group">
    <label for="Inputselect">Service Name </label>
