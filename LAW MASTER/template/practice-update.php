 ...
 if(isset($_POST['update']))
  {
   ...
   if(empty($Country))
   {
 $result = mysqli_query($sql_con, "UPDATE `practice` SET `Title`='$Register',`Short_detail`='$Location',`Long_Detail`='$state' WHERE Sno='$sno'");
 }
 else
 {
     $result = mysqli_query($sql_con, "UPDATE `practice` SET `Title`='$Register',`Short_detail`='$Location',`Long_Detail`='$state',`Image`='$Country' WHERE Sno='$sno'");
 }
  }
 if(isset($_POST['delete']))
{
 $sno = isset($_POST['sno'])?$_POST['sno']:null;
$result1 = mysqli_query($sql_con,"DELETE FROM `practice` WHERE Sno='$sno'");
...
<body>
  <div class="container-scroller">
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Practice Information</h4>
    ...
    <tbody>
        ...
        <?php
$result = mysqli_query($sql_con,"SELECT * FROM `practice` where RegistrationId='$id'");
$count = 0;
while($row = mysqli_fetch_array($result))
{
    $sno = $row['Sno'];
  $Inquiryid = $row['Title'];
  $InquiryName = $row["Short_detail"];
  $State = $row["Long_Detail"];
  $Country = $row["Image"];
  ?>
   <tr>
...
<form method="post" enctype="multipart/form-data">
  ...
  <div class="form-group has-error">
   ...
   <div class="form-group has-error">
    ...
    <textarea type="text" class="form-control" id="State" placeholder="State" name="State"></textarea>
  </div>
   <div class="form-group has-error">
