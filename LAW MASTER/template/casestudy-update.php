...
if(empty($Phone_No))
{
 $result = mysqli_query($sql_con, "UPDATE `casestudy` SET `Title`='$Register',`Date`='$Location',`Time`='$state',`Short_detail`='$Country',`Long_Detail`='$Email_Id' WHERE Sno='$sno'");
 }
 else
 {
   $result = mysqli_query($sql_con, "UPDATE `casestudy` SET `Title`='$Register',`Date`='$Location',`Time`='$state',`Short_detail`='$Country',`Long_Detail`='$Email_Id',`Image`='$Phone_No' WHERE Sno='$sno'");  
 }
  }
...
{
 $sno = isset($_POST['sno'])?$_POST['sno']:null;
$result1 = mysqli_query($sql_con,"DELETE FROM `casestudy` WHERE Sno='$sno'");
...
<body>
  <div class="container-scroller">
    ...
    <tbody>
        ...
        <?php
$result = mysqli_query($sql_con,"SELECT * FROM `casestudy` where RegistrationId='$id'");
$count = 0;
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Case Study Information</h4>
