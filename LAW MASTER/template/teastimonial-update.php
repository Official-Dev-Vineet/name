 ...
 if(isset($_POST['update']))
  {
   ...
   if(empty($Country))
   {
 $result = mysqli_query($sql_con, "UPDATE `testimonial` SET `Name`='$Location',`Designation`='$state' WHERE Sno='$sno'");
 }
 else
 {
     $result = mysqli_query($sql_con, "UPDATE `testimonial` SET `Name`='$Location',`Designation`='$state',`Image`='$Country' WHERE Sno='$sno'");
 }
  }
 if(isset($_POST['delete']))
{
 $sno = isset($_POST['sno'])?$_POST['sno']:null;
$result1 = mysqli_query($sql_con,"DELETE FROM `testimonial` WHERE Sno='$sno'");
...
<body>
  <div class="container-scroller">
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Teastimonial Information</h4>
    ...
    <tbody>
        ...
        <?php
$result = mysqli_query($sql_con,"SELECT * FROM `testimonial` where RegistrationId='$id'");
$count = 0;
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Teastimonial Information</h4>
