...
//case
  ...
  $result = mysqli_query($sql_con, "INSERT INTO `casestudy` (`RegistrationId`, `Title`, `Date`,`Time`,`Short_detail`,`Long_Detail`, `Image`) VALUES ('$id','$title','$date','$time','$detail','$long_detail','$img')");
    ...
    <!-- partial -->
      <div class="main-panel">        
        <div class="content-wrapper">
             <a href="casestudy-update.php?user1=<?php echo $id; ?>" class="btn btn-info" style="margin-bottom: 10px;">Update</a>
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Case Study Master</h4>
