 ...
 if(isset($_POST['update']))
  {
    ...
    $Country = isset($_POST['Country'])?$_POST['Country']:null;
     ...
     $result = mysqli_query($sql_con, "UPDATE `faq` SET `Question`='$Location',`Answer`='$Country' WHERE Sno='$sno'");
 }

 if(isset($_POST['delete']))
{
 $sno = isset($_POST['sno'])?$_POST['sno']:null;
$result1 = mysqli_query($sql_con,"DELETE FROM `faq` WHERE Sno='$sno'");
...
<body>
  <div class="container-scroller">
    ...
    <tbody>
        ...
        <?php
$result = mysqli_query($sql_con,"SELECT * FROM `faq` where RegistrationId='$id'");
$count = 0;
while($row = mysqli_fetch_array($result))
{
    $sno = $row['Sno'];
  $Inquiryid = $row["RegistrationId"];
  $InquiryName = $row["Question"];
  $Country = $row["Answer"];
  ?>
   <tr>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Faq Information</h4>
...
<form method="post" enctype="multipart/form-data">
  ...
  <div class="form-group has-error">
    <label for="time1">Question</label>
    <input type="text" class="form-control" id="Location" placeholder="Location" name="Location">
  </div>
 
   <div class="form-group has-error">
    <label for="time1">Answer</label>
    <textarea type="text" class="form-control" id="Country" placeholder="Country" name="Country"></textarea>
  </div>
