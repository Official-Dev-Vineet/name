 ...
 <div class="page-wrapper">
     <header class="header header-intro-clearance header-4">
        ...
        <div class="page-header text-center" style="background-image: url('assets/images/our product.jpg')">
        		<div class="container">
        			<h1 class="page-title" style="color: white; font-weight: bolder; font-family: Times New Roman, Times, serif;">All Property</h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
  <style>
    .text {
...
<div class="container mt-5 mb-5">
    ...
    <?php
         $Product = mysqli_query($sql_con,"SELECT * FROM `property` where RegistrationId='$user'");
   while($Cate = mysqli_fetch_array($Product))
   {
  ?>
            <div class="bg-white p-3 rounded" style="margin-bottom: 10px;">
                <div class="row">
                    <div class="col-md-3">
                        <div class="d-flex flex-column justify-content-center align-items-center icon-container text-white mb-2">
                            <img src="../image/<?php echo $Cate['Property_Image']; ?>" class="img-thumbnail img-fluid">
                        </div>
                    </div>
                    <div class="col-md-6 border-right">
                        <div class="listing-title">
                            <h5><a href="property-detail.php?id=<?php echo $Cate['Sno']; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" style="color: rgb(11, 127, 171);"><?php echo $Cate['Property_Name']; ?> </a></h5>
                        </div>
                        <div class="d-flex flex-row align-items-center">
                            <p style="color: black"><b><?php echo $Cate['Property_Address']; ?></b></p>
                        </div>
                        <div class="description">
                            <p class="text" style="color: black; font-size: 12px;"><?php echo $Cate['Property_Overview']; ?></p>
                            <br>
                            <center><h6 style="background: rgb(11, 127, 171); color: white; padding: 10px;"><a href="property-detail.php?id=<?php echo $Cate['Sno']; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" style="color: white;">Know More About <?php echo $Cate['Property_Name']; ?>   </a></h6></center>
                        </div>
                    ...
                    <div class="d-flex col-md-3">
                        <div class="d-flex flex-column justify-content-start user-profile w-100">
                            ...
                            <div class="progresses">
                                <center><h3><b>Rs. <?php echo $Cate['Amount']; ?>/-</b></h3></center>
                                <center><h5><?php echo $Cate['Property_Type']; ?></h5></center>
                            </div>
                            <div class="progresses">
                                <center><h6 style="background: rgb(11, 127, 171); color: white; padding: 10px;">Launch Year: <?php echo $Cate['Launch_Year']; ?></h6></center>
                                <center><h6 style="background: rgb(11, 127, 171); color: white; padding: 10px;">Project Area: <?php echo $Cate['Project_Area']; ?></h6></center>
                            </div>
