...
<!-- molla/blog.html  22 Nov 2019 10:04:05 GMT -->
<head>
    <meta charset="UTF-8">
 ...
 <div class="page-wrapper">
     <header class="header header-intro-clearance header-4">
        ...
        <div class="page-header text-center" style="background-image: url('assets/images/our product.jpg')">
        		<div class="container">
        			<h1 class="page-title" style="color: white; font-weight: bolder; font-family: Times New Roman, Times, serif;"><?php echo $Title; ?></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
