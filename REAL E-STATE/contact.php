...
if(isset($_POST['send']))
{
    ...
    $course = isset($_POST['subject'])?$_POST['subject']:null;
    $msg = isset($_POST['message'])?$_POST['message']:null;
    
    $sql = mysqli_query($sql_con, "INSERT INTO contact_inquiry(`RegistrationId`,`InstituteName`,`Name`,`Email`,`Phone`,`Course`,`Messgae`) VALUE('$user','$name','$namees','$email','$phone','$course','$msg')");
}
?>
     ...
     <header class="header header-intro-clearance header-4">
        ...
        <main class="main">
            <div class="page-header text-center" style="background-image: url('assets/images/our product.jpg')">
        		<div class="container">
        			<h1 class="page-title" style="color: white; font-weight: bolder; font-family: Times New Roman, Times, serif;">Contact Us</h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
<div class="page-content pb-0" style="padding-top: 30px; padding-bottom: 30px;">
                <div class="container">
                	<div class="row">
                		<div class="col-lg-6 mb-2 mb-lg-0" style="background: url('https://media.istockphoto.com/photos/businessman-using-a-computer-for-property-sales-listings-realtor-picture-id1335050734?b=1&k=20&m=1335050734&s=170667a&w=0&h=tnK2OCgBSt9UDtAUBuN452cwaUh1_HGdcc2QU5wi2FQ='); background-repeat: no-repeat; background-size: 100%; padding-bottom: 10px;">
                		    <div style="background-color: rgba(11, 127, 171, 0.8); padding-top: 100px; padding-left: 20px; padding-right: 10px; padding-bottom: 100px; margin-top: 20px; margin-bottom: 10px; ">
                			<h1 class="title mb-1" style="color: white; text-align: center; font-weight: bolder; font-size: 27px; text-transform: uppercase; font-family: Times New Roman, Times, serif;">Contact Information</h1><!-- End .title mb-2 -->
                						...
                						<p style="color: white; font-weight: bolder; font-size: 16px; font-family: Times New Roman, Times, serif;">
                							<i class="icon-map-marker" style="color: white; font-size: 20px;"></i>
                							...
                							<p style="color: white; font-weight: bolder; font-size: 16px; ">
                								<i class="icon-envelope" style="color: white; font-size: 20px;"></i>
                		...
                		<div class="col-lg-6" style="padding-bottom: 30px;">
                		    <div style="box-shadow: rgba(6, 24, 44, 0.4) 0px 0px 0px 2px, rgba(6, 24, 44, 0.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset; padding: 15px; background: white;">
                			<h2 class="title mb-1" style="text-align: center; font-weight: bolder; font-size: 27px; text-transform: uppercase; font-family: Times New Roman, Times, serif;">Any Questions?</h2><!-- End .title mb-2 -->
                			
                			<form method="post" class="contact-form mb-3">
                				<div class="row">
                					<div class="col-sm-6">
                                        <label for="cname" class="sr-only" style="color: black;">Name</label>
                						<input type="text" class="form-control" id="cname" name="name" placeholder="Name *" required>
                					</div><!-- End .col-sm-6 -->

                					<div class="col-sm-6">
                                        <label for="cemail" class="sr-only" style="color: black;">Email</label>
                				...
                				<div class="row">
                					<div class="col-sm-6">
                                        <label for="cphone" class="sr-only" style="color: black;">Phone</label>
                						<input type="tel" class="form-control" id="cphone" name="phone" placeholder="Phone">
                					</div><!-- End .col-sm-6 -->

                					<div class="col-sm-6">
                                        <label for="csubject" class="sr-only" style="color: black;">Subject</label>
                						<input type="text" class="form-control" id="csubject" name="subject" placeholder="Subject">
                					</div><!-- End .col-sm-6 -->
                				</div><!-- End .row -->

                                <label for="cmessage" class="sr-only" style="color: black;">Message</label>
                				<textarea class="form-control" cols="30" rows="4" id="cmessage" name="message" required placeholder="Message *"></textarea>

                			<center>	<button type="submit" align="center" class="btn btn-minwidth-sm" name="send" style="background:  rgb(11, 127, 171); color: white; float: center;">
                					<span>SUBMIT</span>
