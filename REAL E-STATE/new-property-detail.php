...
$result = mysqli_query($sql_con, "SELECT * FROM new_property where RegistrationId='$user' and Sno='$sno'");
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="product-details">
                                    <h1 class="product-title"><?php echo $productname; ?></h1><!-- End .product-title -->
                                    <h5 class="product-title"><?php echo $type; ?></h5>
                                    
                                    <p style="color: black; font-size: 14px;"><?php echo $productquantity; ?></p>
                                    
                                    <div class="product-price">
                                      <p style="color: black; font-size: 16px; font-weight: bold;"> Rs. <?php echo $productrate; ?>/- </p>
...
<div class="product-details-tab" style="margin-top: 30px;">
 ...
 <?php
$video = mysqli_query($sql_con, "SELECT * FROM new_property where Sno='6'");
