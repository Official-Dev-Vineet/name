 ...
 <div class="page-wrapper">
     <header class="header header-intro-clearance header-4">
        ...
        <main class="main">
            ...
            <div class="container-fluid" style="background: #f2f3f4; padding-top: 30px; padding-bottom: 40px;">
                <h3 class=" text-center" style="font-family: Amasis MT Pro; margin-bottom: 0px; font-size: 28px; font-weight: bold; color: black; text-align: center;">Top Properties</h3><!-- End .title text-center -->
                ...
                <div class="tab-content tab-content-carousel just-action-icons-sm">
                    <div class="tab-pane p-0 fade show active" id="new-all-tab" role="tabpanel" aria-labelledby="new-all-link">
                        ...
                        <?php 
                        $result = mysqli_query($sql_con, "SELECT * FROM property where RegistrationId='$user' ");
                        while($row = mysqli_fetch_array($result))
                        {
                            $category = $row['Property_Name'];
                            $type = $row['Property_Type'];
                            $images = $row['Property_Image'];
                            $amount = $row['Amount'];
                            $location = $row['Property_Address'];
                        ?>
                            <div class="product product-2" style="background-color: rgb(11, 127, 171); 
}">
                                <figure class="product-media">
                                   
                                    <a href="property-detail.php?id=<?php echo $Cate['Sno']; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>">
                                        <img src="../image/<?php echo $images; ?>" alt="Product image" class="product-image img-thumbnail img-responsive">
                                    </a>

                                   <!-- End .product-action -->
                                </figure><!-- End .product-media -->

                                <div class="product-body" style="background-color: rgb(11, 127, 171); color: white; padding-left: 5px; padding-right: 5px; ">
                                    
                                    <h3 class="product-title" style="text-align: center; color: white; margin-bottom: 0px; text-transform: uppercase;"><a href="property-detail.php?id=<?php echo $row['Sno']; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>"><?php echo $category; ?></a></h3><!-- End .product-title -->
                                    <p style="padding: 0px; line-height: 20px; text-align: center;"><a href="property-detail.php?id=<?php echo $row['Sno']; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" style="color: black; font-size: 12px; color: white;"><i class="fa fa-map-marker"></i> <?php echo $location; ?></a></p>
                          <!--  <p style="padding: 0px; line-height: 20px; text-align: left;"><a href="property-detail.php?id=<?php echo $row['Sno']; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" style="color: black; font-size: 12px; color: white; text-align: left; margin-left: 50px;"><i class="fa fa-home"></i> <?php echo $type; ?><font style="float: center; margin-left: 50px;">Rs.<?php echo $amount; ?>/-</font></a></p>
                                    -->
 
                                <div class="row">
                                    
                                        <div class="col-6">
                                          <p  style="text-align: center;"><a href="property-detail.php?id=<?php echo $Cate['Sno']; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" style="color: white; "><i class="fa fa-home"></i> <?php echo $type; ?></a></p>  
                                        </div>
                                        <div class="col-6">
                                            <p style="text-align: center;"><a href="property-detail.php?id=<?php echo $Cate['Sno']; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" style="color: white; ">Rs. <?php echo $amount; ?>/-</a></p>
                                        </div>
...
?>
            ...
            <div class="container-fluid new-arrivals" style="background-color: rgb(11, 127, 171); padding-bottom: 40px; margin-bottom: 0px;">

                    <div class="heading-center" align="center;">
                        <h3 class=" text-center" style="font-family: Amasis MT Pro; margin-bottom: 5px; font-size: 28px; font-weight: bold; color: white; text-align: center; padding-top: 10px;">Top Project</h3><!-- End .title text-center -->
                <hr style="height:2px;border-width:0;color: white;background-color: white; margin-top: 0px; text-align: center; width: 50%;"><!-- End .title -->
                ...
                <div class="tab-content tab-content-carousel just-action-icons-sm">
                    <div class="tab-pane p-0 fade show active" id="new-all-tab" role="tabpanel" aria-labelledby="new-all-link">
                       ...
                       <?php 
                        $result = mysqli_query($sql_con, "SELECT * FROM property where RegistrationId='$user' and Top_Property='Yes'");
                        while($row = mysqli_fetch_array($result))
                        {
                            $category = $row['Property_Name'];
                            $type = $row['Property_Type'];
                        ...
                        ?>
                            <div class="product product-2">
                                <figure class="product-media">
                                    ...
                                    <a href="property-detail.php?id=<?php echo $row['Sno']; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>">
                                ...
                                <div class="product-body" style="padding-left: 5px; padding-right: 5px;">
                                    <div class="product-cat">
                                    </div><!-- End .product-cat -->
                                    <h3 class="product-title" style="text-align: center;"><a href="property-detail.php?id=<?php echo $row['Sno']; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>"><?php echo $category; ?></a></h3><!-- End .product-title -->
                                     <p style="padding: 0px; line-height: 20px; text-align: center;"><a href="property-detail.php?id=<?php echo $row['Sno']; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" style="color: black; font-size: 12px; text-align: left; text-align: center;"> <?php echo $location; ?></a></p>
                                   <div class="row">
                                    
                                        <div class="col-6">
                                          <p  style="text-align: center;"><a href="property-detail.php?id=<?php echo $Cate['Sno']; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" style="color: black; "><i class="fa fa-home"></i> <?php echo $type; ?></a></p>  
                                        </div>
                                        <div class="col-6">
                                            <p style="text-align: center;"><a href="property-detail.php?id=<?php echo $Cate['Sno']; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" style="color: black; ">Rs. <?php echo $amount; ?>/-</a></p>
                                        </div>
...
?>
            ...
            <div class="container-fluid" style="background: #f2f3f4; margin-top: 0px;  padding-bottom: 40px;">
                <h3 class=" text-center" style="font-family: Amasis MT Pro; margin-bottom: 0px; font-size: 28px; font-weight: bold; color: black; text-align: center; margin-bottom: 5px; padding-top: 20px;">New Project Gallery </h3><!-- End .title text-center -->
                <hr style="height:2px;border-width:0;color:gray;background-color: black; margin-top: 0px; text-align: center; width: 50%;">
                ...
                <div class="tab-content tab-content-carousel just-action-icons-sm">
                    <div class="tab-pane p-0 fade show active" id="new-all-tab" role="tabpanel" aria-labelledby="new-all-link">
                       ...
                       <?php 
                        $result = mysqli_query($sql_con, "SELECT * FROM new_property where RegistrationId='$user'");
                        while($row = mysqli_fetch_array($result))
                        {
                            $category = $row['Property_Name'];
                            $type = $row['Property_Type'];
                            ...
                            $sno = $row['Sno'];
                        ?>
                            <div class="product product-2" style="background: rgb(11, 127, 171);">
                                <figure class="product-media">
                                   
                                    <a href="new-property-detail.php?id=<?php echo $row['Sno']; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>">
                                        <img src="../image/<?php echo $images; ?>" alt="Product image" class="product-image">
                                    </a>
                                ...
                                <div class="product-body" style="background: rgb(11, 127, 171); color: white; padding-left: 5px; padding-right: 5px;">
                                    <div class="product-cat">
                                    </div><!-- End .product-cat -->
                                    <h3 class="product-title" style="text-align: center; color: white;"><a href="new-property-detail.php?id=<?php echo $sno; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>"><?php echo $category; ?></a></h3><!-- End .product-title -->
                                    <p style="padding: 0px; line-height: 20px; text-align: center;"><a href="new-property-detail.php?id=<?php echo $row['Sno']; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" style="color: white; font-size: 12px; text-align: center;"> <?php echo $location; ?></a></p>
                               <div class="row">
...
<div class="container-fluid" style="background: rgb(11, 127, 171); margin-top: 0px;  padding-bottom: 40px;">
                <h3 class=" text-center" style="font-family: Amasis MT Pro; margin-bottom: 0px; font-size: 28px; font-weight: bold; color: white; text-align: center; padding-top: 20px;">Our Gallery</h3><!-- End .title text-center -->
                <hr style="height:2px;border-width:0;color:gray;background-color: white; margin-top: 0px; text-align: center; width: 50%;">
                        ...
                        ?>
                            <div class="product product-2">
                                <figure class="product-media">
                                    ...
                                    <a href="../image/<?php echo $images; ?>" target="_blank">
                                        <img src="../image/<?php echo $images; ?>" alt="Product image" class="product-image" style="height: 200px;">
                                    </a>
                                ...
                                <div class="product-body" style="padding-left: 5px; padding-right: 5px;">
                                    ...
                                    <h3 class="product-title" style="text-align: center;"><a href="product-detail.php?id=<?php echo $Cate['id']; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>"><?php echo $category; ?></a></h3><!-- End .product-title -->
                                    <!-- End .product-price -->
...
?>
            ...
            <div class="container">
                ...
                <h3 style="font-family: Amasis MT Pro; margin-bottom: 0px; font-size: 28px; font-weight: bold; color: black; text-align: center; padding-top: 20px;">Our Client</h3>
                <hr style="height:2px;border-width:0;color:gray;background-color: black; margin-top: 0px; text-align: center; width: 50%;">
