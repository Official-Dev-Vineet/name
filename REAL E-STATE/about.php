...
<div class="container-fluid" style="background-color: rgb(11, 127, 171); text-align: center;">
     ...
     <header class="header header-intro-clearance header-4">
        ...
        <main class="main">
          <div class="page-header text-center" style="background-image: url('assets/images/our product.jpg')">
        		<div class="container">
        			<h1 class="page-title" style="color: white; font-weight: bolder; font-family: Times New Roman, Times, serif;">About Us</h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6  mb-lg-0">
                                <h2 class="title" style="font-family: Amasis MT Pro; margin-bottom: 5px; font-size: 28px; font-weight: bold; color: black; text-align: center; padding-top: 10px;">Who We Are</h2><!-- End .title -->
                                <hr style="height:2px;border-width:0;color: white;background-color: black; margin-top: 0px; text-align: center; width: 50%;">
                            ...
                            <div class="col-lg-5 offset-lg-1">
                                <div class="about-images">
                                    <img src="../image/<?php echo $images; ?>" alt="" class="about-img-front" style="width: 100%; height: 100%;">
 ...
 <div class="container-fluid" style="background-color: rgb(11, 127, 171); margin-bottom: 0px; padding-top: 0px; margin-top: 0px;">
                    <div class="row">
                        <div class="col-lg-6 mb-lg-0">
                            <div style="box-shadow: rgba(17, 17, 26, 0.05) 0px 1px 0px, rgba(17, 17, 26, 0.1) 0px 0px 8px; margin-top: 20px; margin-bottom: 20px; padding: 20px; background: white;">
...
<style>
   ...
   -webkit-box-orient: vertical;
    ...
    <footer class="footer" style="background-color: #d8232a;">
