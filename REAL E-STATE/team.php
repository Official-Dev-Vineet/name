 ...
 <div class="page-wrapper">
     <header class="header header-intro-clearance header-4">
        ...
        <div class="page-header text-center" style="background-image: url('assets/images/our product.jpg')">
        		<div class="container">
        			<h1 class="page-title" style="color: white; font-weight: bolder; font-family: Times New Roman, Times, serif;">Our Team</h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
        ...
        <div class="col-lg-12">
            <div class="row">
                ...
                <div class="col-md-3 d-flex">
                    <div class="card mb-3" style="background-color: rgb(11, 127, 171); text-align: center;">
                        <img class="card-img-top img-fluid" src="../image/<?php echo $image; ?>" alt="John Doe" style="height: 250px; width: 300px;">
                        <div class="card-body py-3">
                            <h5 class="mb-0" style="text-align: center; color: white;"><?php echo $name; ?></h5>
                            <h6 style="text-align: center; color: white;"><?php echo $desi; ?></h6>
                        </div>
