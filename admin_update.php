...
<body>
  ...
  <div class="container" style="margin-top: 4rem;">
    ...
    <div class="flex">
      ...
      <ul>
        <li><a href="admin_master.php">Master</a></li>
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><button type="button" class="btn btn-primary" data-toggle="modal" onclick="document.getElementById('Product').value = '<?php echo $product; ?>';document.getElementById('Product_Category').value = '<?php echo $Product_Category; ?>';document.getElementById('ProductImage').value = '<?php echo $image; ?>';" data-target="#myModal2">Details</button></td>
                </tr>
              <?php
              }
              ?>
