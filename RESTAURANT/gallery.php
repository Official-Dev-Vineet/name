...
<div class="container-fluid" style="background-color:  #003153; text-align: center;">
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
        		...
        		<div class="container">
        			<h1 class="page-title" style="color: white; font-weight: bold;">Gallery</h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
           ...
           <div class="col-md-3">
               <div>
                   ...
                   <img src="../image/<?php echo $Image; ?>" class="img-fluid img-thumbnail" style=" width: 100%; height: 100%;">
                   </a>
               </div>
           </div>
