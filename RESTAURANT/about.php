    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <div class="page-content pb-0">
                ...
                <div class="bg-light-2 pt-6 pb-5 " style="margin-bottom: 0px;">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 mb-3 mb-lg-0">
                                <h2 class="title" style="font-family: Amasis MT Pro; margin-bottom: 0px; font-size: 28px; font-weight: bold; padding-bottom: 10px;">Who We Are</h2><!-- End .title -->
                            ...
                            <div class="col-lg-5 offset-lg-1">
                                <div class="about-images">
                                    <img src="../image/<?php echo $images; ?>" alt="" class="about-img-front img-thumbnail" style="height: 100%; width: 100%;">
                 ...
                 <div class="container-fluid" style="background: #003153; margin-top: 0px; padding-bottom: 30px;">
                    <div class="row">
                        <div class="col-lg-6 mb-3 mb-lg-0">
                            <div style="box-shadow: rgba(6, 24, 44, 0.4) 0px 0px 0px 2px, rgba(6, 24, 44, 0.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset; padding: 15px; margin-top: 30px; background: white;">
                            <h2 class="title" style="font-family: Amasis MT Pro; margin-bottom: 0px; font-size: 28px; font-weight: bold; color: black; text-align: center;">Our Vision</h2><!-- End .title -->
                        ...
                        <div class="col-lg-6">
                            <div style="box-shadow: rgba(6, 24, 44, 0.4) 0px 0px 0px 2px, rgba(6, 24, 44, 0.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset; padding: 15px; margin-top: 30px; background-color: white;">
                            <h2 class="title" style="font-family: Amasis MT Pro; margin-bottom: 0px; font-size: 28px; font-weight: bold; color: black; text-align: center;">Our Mission</h2><!-- End .title -->
                            <hr style="height:2px;border-width: 50%;color:gray;background-color: black; margin-bottom: 10px; margin-top: 10px; width: 50%; font-size: 26px;">
