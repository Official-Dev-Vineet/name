...
<div class="container-fluid" style="background-color:  #003153; text-align: center;">
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
        		...
        		<div class="container">
        			<h1 class="page-title" style="color: white; font-weight: bold;">Contact Us</h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
                ...
                <div class="container">
                	<div class="row">
                		<div class="col-lg-6 mb-2 mb-lg-0">
                		    <div style="background-color: #003153; padding: 20px;">
                		...
                		<div class="col-lg-6" style="padding-bottom: 30px;">
                			...
                			<center>	<button type="submit" align="center" class="btn btn-minwidth-sm" style="background: #003153; color: white; float: center;">
                					<span>SUBMIT</span>
