    ...
    <div class="page-wrapper">
        ...
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/our product.jpg')">
        		<div class="container">
        			<h1 class="page-title" style="color: white; font-weight: bolder; font-size: 44px; text-transform: uppercase;"><?php echo $category; ?></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
                		...
                		<div class="col-lg-9">
                            ...
                            <div class="products mb-3">
                                <div class="row justify-content-center">
                                    ...
                                    <?php
         $Product = mysqli_query($sql_con,"SELECT * FROM `product` where RegistrationId='$user' and ProductCategory='$category'");
