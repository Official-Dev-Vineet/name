...
<?php
    ...
    while($rowa = mysqli_fetch_array($about))
    {
        ...
        $image = $rowa['Image'];
        $mission = $rowa['Mission'];
        $vission = $rowa['Vission'];
    }
    ?>
            <!-- About Start -->
            <div class="about">
                ...
                <div class="container">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6">
                            <div style="background: #121518; margin: 10px; padding: 10px;">
                            <h3 style="color: #aa9166; text-align: center;">Our Mission</h3>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div style="background: #121518; margin: 10px; padding: 10px;">
                            <h3 style="color: #aa9166; text-align: center;">Our Vission</h3>
                            <div class="about-text" style="color: white">
                               <?php echo $vission; ?>
                            </div>
                        </div>
