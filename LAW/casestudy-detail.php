...
$blog = mysqli_query($sql_con, "SELECT * FROM casestudy where RegistrationId='$user' and Sno='$id'");
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <p style="color: black; text-align: justify;"><?php echo $short; ?></p>
                            <p style="color: black; text-align: justify;"><?php echo $long; ?></p>
