        ...
        <div class="wrapper">
            ...
            <div class="portfolio">
                <div class="container">
                    ...
                    <?php
                    $case = mysqli_query($sql_con, "SELECT * FROM casestudy where RegistrationId='$user'");
                    while($cas = mysqli_fetch_array($case))
                    {
                        $Title = $cas['Title'];
                        $Date = $cas['Date'];
                        $Time = $cas['Time'];
                    ...
                    ?>
                        <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item first">
                            <div class="portfolio-wrap">
                               <a href="casestudy-detail.php?user6=<?php echo $user; ?>&name=<?php echo $name; ?>&ided=<?php echo $Sno; ?>"> <img src="../image/<?php echo $image; ?>" alt="Portfolio Image"></a>
                                <figure>
                                    <a href="casestudy-detail.php?user6=<?php echo $user; ?>&name=<?php echo $name; ?>&ided=<?php echo $Sno; ?>" style="color: white;"><?php echo $Title; ?></a>
                                    <span style="color: white;"><?php echo $Date; ?></span>
                                </figure>
                            </div>
                        </div>
<?php
