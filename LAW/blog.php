                ...
                <div class="container">
                    ...
                    <div class="row blog-page">
                        ...
                        while($blo = mysqli_fetch_array($blog))
                        {
                            ...
                            $ided = $blo['Sno'];
                        ?>
                        <div class="col-lg-4 col-md-6 blog-item" style="padding: 10px;">
                            <div style="box-shadow: rgba(6, 24, 44, 0.4) 0px 0px 0px 2px, rgba(6, 24, 44, 0.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset; padding: 10px;">
