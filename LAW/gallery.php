            ...
            <div class="portfolio">
                <div class="container">
                    ...
                    <div class="row portfolio-container">
                     ...
                     <?php
                     $galle = mysqli_query($sql_con, "SELECT * FROM gallery where RegistrationId='$user'");
                     while($gal = mysqli_fetch_array($galle))
                     {
                         $img = $gal['Image'];
                     ?>
                        <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item first">
                         <a href="../image/<?php echo $img; ?>" target="_blank">  <div class="portfolio-wrap" style="margin-bottom: 10px;">
                                <img src="../image/<?php echo $img; ?>" alt="Portfolio Image" style="height: 200px;" class="img-fluid img-thumbnail">
                             </a>  
                            </div>
                        </div>
                        <?php
