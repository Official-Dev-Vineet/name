    ...
    <div class="page-wrapper">
        ...
        <main class="main">
           <div class="page-header text-center" style="background-image: url('assets/images/our product.jpg')">
        		<div class="container">
        			<h1 class="page-title" style="color: white; font-weight: bold;"><?php echo $productname; ?></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->

            <div class="page-content" style="margin-top: 30px; padding-bottom: 0px;">
                <div class="container">
                    <div class="product-details-top">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="product-gallery product-gallery-vertical" style="box-shadow: rgba(6, 24, 44, 0.4) 0px 0px 0px 2px, rgba(6, 24, 44, 0.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset; padding: 20px; background-color: white;">
                            ...
                            <div class="col-md-6">
                                <div style="box-shadow: rgba(6, 24, 44, 0.4) 0px 0px 0px 2px, rgba(6, 24, 44, 0.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset; padding: 20px; background-color: white;">
                                <div class="product-details">
                                    <h1 class="product-title" style="font-family: Amasis MT Pro; margin-bottom: 0px; padding-top: 0px; margin-top: 0px; padding-top: 20px; font-size: 28px; font-weight: bold;"><?php echo $productname; ?></h1><!-- End .product-title -->

                                    <div class="product-price" style="font-family: Amasis MT Pro; margin-bottom: 0px; padding-top: 0px; margin-top: 0px; padding-top: 0px; font-size: 28px; font-weight: bold;">
                                       Rs. <?php echo $productrate; ?>/-
                                    </div><!-- End .product-price -->

                                    </div><!-- End .details-filter-row -->

                                    <div class="details-filter-row details-row-size">
                                        <label for="qty" style="font-family: Amasis MT Pro; margin-bottom: 0px; padding-top: 0px; margin-top: 0px; padding-top: 0px; font-size: 28px; font-weight: bold;">Qty:</label>
                                    ...
                                    <div class="product-details-action">
                                        <a href="#" class="btn" style="background-color: #32aeb1; color: white;"><span>Buy</span></a>
                    ...
                    <div class="product-details-tab">
                        <ul class="nav nav-pills justify-content-center" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="product-desc-link" data-toggle="tab" href="#product-desc-tab" role="tab" aria-controls="product-desc-tab" aria-selected="true" style="font-family: Amasis MT Pro; margin-bottom: 0px; padding-top: 0px; margin-top: 0px; padding-top: 20px; font-size: 28px; font-weight: bold;">Description</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="product-info-link" data-toggle="tab" href="#product-info-tab" role="tab" aria-controls="product-info-tab" aria-selected="false" style="font-family: Amasis MT Pro; margin-bottom: 0px; padding-top: 0px; margin-top: 0px; padding-top: 20px; font-size: 28px; font-weight: bold;">Additional information</a>
                            </li>
                            
                        </ul>
                        <div class="tab-content" style="box-shadow: rgba(6, 24, 44, 0.4) 0px 0px 0px 2px, rgba(6, 24, 44, 0.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset; background-color: white;">
