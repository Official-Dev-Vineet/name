                		...
                		<div class="col-lg-9">
                            ...
                            <div class="products mb-3" >
                                <div class="row justify-content-center">
                                    ...
                                    <?php
         $Product = mysqli_query($sql_con,"SELECT * FROM `product` where RegistrationId='$user' and ProductCategory='$ides'");
                				...
                				<div class="widget widget-collapsible">
									...
									<div class="collapse show" id="widget-1">
										<div class="widget-body">
											...
											<?php
$Product = mysqli_query($sql_con,"SELECT any_value(ProductCategory) as ProductCategorys FROM `product` WHERE RegistrationId='$user' GROUP BY ProductCategory limit 15");
   while($Cate = mysqli_fetch_array($Product))
   {
											?>
												<div class="filter-item">
													<div class="custom-control">
													<a href="category.php?id=<?php echo $Cate['ProductCategorys']; ?>&user6=<?php echo $user; ?>&name=<?php echo $nam; ?>">
