...
<div class="page-wrapper">
  <header class="header header-intro-clearance header-4">
            <div class="header-middle" style="background: #32aeb1;" >
            <div class="container">
                <div class="header-left">
                 <button class="mobile-menu-toggler" style="background: white;">
                            <span class="sr-only">Toggle mobile menu</span>
                            <i class="icon-bars"></i>
                        </button>
                        
                        <a href="index.php?user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" class="logo">
                            <img src="../image/<?php echo $logo; ?>" alt="Molla Logo" style="height: 80px;">
                        </a>
                    </div><!-- End .header-left -->
                   ...
                   <div class="header-center">
                        <nav class="main-nav">
                            <ul class="menu sf-arrows">
                                ...
                                <li class="megamenu-container active">
                                 <a href="index.php?user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" style="color: white; width: 80px;">Home</a>
                                </li>
                                
                                <li class="megamenu-container">
                                 <a href="about.php?user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" style="color: white; width: 80px;">About</a>
                                </li>
                            
                                <li class="megamenu-container">
                                 <a href="medicine.php?user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" style="color: white; width: 100px;">Medicine</a>
                                </li>
                                
                                <li class="megamenu-container">
                                 <a href="gallery.php?user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" style="color: white; width: 100px;">Gallery</a>
                                </li>
                                
                                 <li class="megamenu-container">
                                 <a href="team.php?user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" style="color: white; width: 80px;">Team</a>
                                </li>
                                
                                <li class="megamenu-container">
                                 <a href="blog.php?user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" style="color: white; width: 80px;">Blog</a>
                                </li>
                               
                               <li class="megamenu-container">
                                 <a href="contact.php?user6=<?php echo $user; ?>&name=<?php echo $nam; ?>" style="color: white; width: 80px;">Contact</a>
                                </li>
                    ...
                    <div class="header-right">
                        ...
                        <div class="wishlist">
                            <a href="wishlist.php" title="Wishlist" style="color: white;">
                                <div class="icon">
                                    <i class="icon-heart-o"></i>
        ...
        <main class="main">
            ...
            <div class="container-fluid" style="padding: 0px;">
	        	<div class="page-header page-header-big text-center" style="background-image: url('assets/images/contact-header-bg.jpg'); min-height: 0px;">
                ...
                <div class="container">
                	<div class="row">
                		<div class="col-lg-6 mb-2 mb-lg-0">
                		    <div style="background-color: #32aeb1; padding: 20px;">
                			<h1 class="title mb-1" style="color: white; text-align: center; font-weight: bolder; font-size: 27px; text-transform: uppercase; font-family: Times New Roman, Times, serif;">Contact Information</h1><!-- End .title mb-2 -->
                			
                						<p style="color: white; font-weight: bolder; font-size: 22px; font-family: Times New Roman, Times, serif;">
                							<i class="icon-map-marker" style="color: white; font-size: 22px;"></i>
	                							<?php echo $location; ?>, <?php echo $city; ?>, <?php echo $State; ?>, <?php echo $pincode; ?>, <?php echo $country; ?>
	                						</p>
                							<p style="color: white; font-weight: bolder; font-size: 22px;">
                								<i class="icon-phone" style="color: white; font-size: 22px;"></i>
                								<a href="tel:#" style="color: white; font-family: Times New Roman, Times, serif;"><?php echo $MobileNo; ?></a>
                							</p>
                							<p style="color: white; font-weight: bolder; font-size: 22px; ">
                								<i class="icon-envelope" style="color: white; font-size: 22px;"></i>
                								<a href="mailto:#" style="color: white; font-family: Times New Roman, Times, serif;"><?php echo $EmailId; ?></a>
                							</p>
                						</ul><!-- End .contact-list -->
                			</div>
                		</div><!-- End .col-lg-6 -->
                		<div class="col-lg-6">
                			<h2 class="title mb-1" style="text-align: center; font-weight: bolder; font-size: 27px; text-transform: uppercase; font-family: Times New Roman, Times, serif;">Got Any Questions?</h2><!-- End .title mb-2 -->
	            	...
	            	<div class="row">
	            		<div class="col-sm-6 col-lg-4">
	            			<div class="widget widget-about" style=" margin-bottom: 6px;">
	            				...
	            				<p style="color: white; font-family: Times New Roman, Times, serif;" class="text-sm"><?php echo $descrip; ?></p>
...
?>
	            		...
	            		<div class="col-sm-6 col-lg-2">
	            			<div class="widget" style="margin-bottom: 10px;">
	            				<h4 class="widget-title" style="color: white; font-size: 20px; margin-bottom: 6px; text-decoration: underline; font-family: Times New Roman, Times, serif;">Useful Links</h4><!-- End .widget-title -->

	            				<ul class="widget-list">
	            					<li><a href="index.php?user6=<?php echo $user; ?>$name=<?php echo $nam; ?>" style="color: white; font-size: 16px; font-family: Times New Roman, Times, serif;">Home</a></li>
	            					<li><a href="about.php?user6=<?php echo $user; ?>$name=<?php echo $nam; ?>" style="color: white; font-size: 16px; font-family: Times New Roman, Times, serif;">About Us</a></li>
	            					<li><a href="medicine.php?user6=<?php echo $user; ?>$name=<?php echo $nam; ?>" style="color: white; font-size: 16px; font-family: Times New Roman, Times, serif;">Medicine</a></li>
	            					
	            					<li><a href="team.php?user6=<?php echo $user; ?>$name=<?php echo $nam; ?>" style="color: white; font-size: 16px; font-family: Times New Roman, Times, serif;">Team</a></li>
	            					<li><a href="contact.php?user6=<?php echo $user; ?>$name=<?php echo $nam; ?>" style="color: white; font-size: 16px; font-family: Times New Roman, Times, serif;">Contact Us</a></li>
	            				</ul><!-- End .widget-list -->
	            			</div><!-- End .widget -->
	            		</div><!-- End .col-sm-6 col-lg-3 -->
	            		...
	            		<div class="col-sm-6 col-lg-2">
	            			<div class="widget" style="margin-bottom: 10px;">
	            				<h4 class="widget-title" style="color: white; font-size: 20px; margin-bottom: 6px; text-decoration: underline; font-family: Times New Roman, Times, serif;">Our Brand</h4><!-- End .widget-title -->
	            				...
	            				<ul class="widget-list">
	            				    ...
	            				    while($men = mysqli_fetch_array($menupr))
	            				    {
	            				        ...
	            				        $ide = $men['Sno'];
	            				    ?>
	            					<li><a href="#" style="color: white; font-size: 16px; font-family: Times New Roman, Times, serif;"><?php echo $produ; ?></a></li>
	            					<?php
	            				    }
	            				    ?>
	            		...
	            		<div class="col-sm-6 col-lg-4">
	            			<div class="widget">
	            				<h4 class="widget-title" style="color: white; font-size: 20px; margin-bottom: 6px; text-decoration: underline; font-family: Times New Roman, Times, serif;">Contact Us</h4><!-- End .widget-title -->

	            				<ul class="widget-list">
	            					<li><a href="#" style="color: white; font-size: 16px; font-family: Times New Roman, Times, serif;"><?php echo $location; ?>, <?php echo $city; ?>, <?php echo $State; ?>, <?php echo $pincode; ?>, <?php echo $country; ?></a></li>
	            					<li><a href="#" style="color: white; font-size: 16px; font-family: Times New Roman, Times, serif;"><?php echo $MobileNo; ?></a></li>
	            					<li><a href="#" style="color: white; font-size: 16px; font-family: Times New Roman, Times, serif;"><?php echo $EmailId; ?></a></li>
