...
if(isset($_POST['send']))
{
    ...
    $contact = mysqli_query($sql_con, "INSERT INTO book_appointment(`RegistrationId`,`InstituteName`,`Name`,`Email`,`Phone`,`Subject`,`Message`) Value('$user','$name','$namees','$email','$phone','$subject','$message')");
}
                                    ...
                                    <div class="uni-send-a-message">
                                        ...
                                        <div class="uni-send-a-message-body">
                                            <form method="post">
                                                ...
                                                <div class="input-group form-group">
                                                    <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                                                    <input type="text" class="form-control" name="subject" value="" placeholder="your Subject">
                                                </div>
                                       
                                                <div class="input-group form-group">
                                                <textarea id="message" class="form-control" placeholder="note" name="message"></textarea>
                                                </div>
