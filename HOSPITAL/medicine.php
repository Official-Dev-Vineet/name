                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                            ...
                                            <div class="category-product uni-product-wapper">
                                                <div class="row">
                                                 <?php
                                                 $prod = mysqli_query($sql_con, "SELECT * FROM product where RegistrationId='$user'");
                                                                ...
                                                                <li>
                                                                    <div class="wrapper">
                                                                        <div class="feature-image" >
                                                                            <a href="medicine-detail.php?id=<?php echo $sn; ?>&user6=<?php echo $user; ?>&name=<?php echo $name; ?>" ><img class="img-fluid" style="padding: 0px" src="../image/<?php echo $img; ?>" alt=""></a>
                                                                        </div>
                                                                        <!-- .feature-image -->
                                                                        ...
                                                                        <div class="stats">
                                                                            <div class="box-title">
                                                                                <h2 class="title-product">
                                                                                    <a href="medicine-detail.php?id=<?php echo $sn; ?>&user6=<?php echo $user; ?>&name=<?php echo $name; ?>" class="product_name"><?php echo $nam; ?></a>
                                                                                </h2>
                                                                                <!-- .title-product -->
                                                                            </div>
                                                                            <!-- .box-title -->
