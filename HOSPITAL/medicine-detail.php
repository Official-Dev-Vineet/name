...
$prod = mysqli_query($sql_con, "SELECT * FROM product where RegistrationId='$user' and id='$id'");
 while($pro = mysqli_fetch_array($prod))
    {
        $category = $pro['ProductCategory'];
        $nam = $pro['ProductName'];
        $rate = $pro['ProductRate'];
            ...
            <div class="site-content-area">
                ...
                <main id="main" class="site-main">
                    <div class="uni-single-product-body">
                        <div class="container">
                            <div id="content" style="padding-bottom: 0px; padding-top: 30px;"> 
                                <div class="row">
                                    <div class="col-md-3">
                                            ...
                                            <div class="uni-siderbar-left">
                                                ...
                                                <div class="vk-category">
                                                    ...
                                                    <ul class="list-career">
                                                      <?php
    $prod = mysqli_query($sql_con, "SELECT any_value(ProductCategory) as ProductCategorys FROM product where RegistrationId='$user' group by ProductCategory limit 10");
                                        while($pro = mysqli_fetch_array($prod))
                                        {
                                            $category = $pro['ProductCategorys'];
                                          
                                        ?>  
                                                        <li><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i> <?php echo $category; ?></a></li>
                                                        <?php
                                                        }
                                                        ?>
                                                    </ul>
                                                ...
                                                <div class="product-info">
                                                    <div class="row">
                                                            ...
                                                            <div id="carousel" class="flexslider thumbnail_product">
                                                                <div id="slider" class="flexslider">
                                                                    <div class="product-slide">
                                                                        <div class="img-slide">
                                                                            <img class="filter2 animated fadeIn shop2 img-responsive" src="../image/<?php echo $img1; ?>" alt="product">
                                                                            <img class="filter2 animated fadeIn shop1 active img-responsive" src="../image/<?php echo $img; ?>" alt="product">
                                                                            <img class="filter2 animated fadeIn shop3 img-responsive" src="../image/<?php echo $img2; ?>" alt="product">
                                                                            <img class="filter2 animated fadeIn shop4 img-responsive" src="../image/<?php echo $img3; ?>" alt="product">
                                                                        </div>

                                                                        <div class="row-fix">
                                                                            <div class="col-xs-3 col-sm-3 col-md-3 uni-clear-padding">
                                                                                <div class="img-small active">
                                                                                    <img data-filter2="shop1" src="../image/<?php echo $img; ?>" alt="product" class="img-responsive">
                                                                                </div>
                                                                            </div>

                                                                            <div class="col-xs-3 col-sm-3 col-md-3 uni-clear-padding">
                                                                                <div class="img-small">
                                                                                    <img data-filter2="shop2" src="../image/<?php echo $img1; ?>" alt="product" class="img-responsive">
                                                                                </div>
                                                                            </div>

                                                                            <div class="col-xs-3 col-sm-3 col-md-3 uni-clear-padding">
                                                                                <div class="img-small">
                                                                                    <img data-filter2="shop3" src="../image/<?php echo $img2; ?>" alt="product" class="img-responsive">
                                                                                </div>
                                                                            </div>

                                                                            <div class="col-xs-3 col-sm-3 col-md-3 uni-clear-padding">
                                                                                <div class="img-small">
                                                                                    <img data-filter2="shop4" src="../image/<?php echo $img3; ?>" alt="product" class="img-responsive">
                                                                                </div>
                                                                            </div>
                                                                            <div class="clearfix"></div>
                                                                        </div>
                                                        ...
                                                        <div class="col-sm-6 right">
                                                            <h1 class="product_title entry-title"><?php echo $nam; ?></h1>
                                    ...
                                    <p><b>Product Brand:</b> <?php echo $brand; ?></p>
                                    <p><b>Product Weight:</b> <?php echo $ProductWeight; ?></p>
                                                            </div>
                                                            <!-- .description -->
                                                                                ...
                                                                                <div class="tab-content">
                                                                                    ...
                                                                                    <div class="tab-pane" id="review">
                                                                                        <div class="woocommerce-Tabs-panel woocommerce-Tabs-panel--reviews panel entry-content wc-tab" id="tab-reviews">
                                                                                            <p><?php echo nl2br($Specifications,"/n"); ?></p>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
