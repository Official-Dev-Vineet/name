...
$blog = mysqli_query($sql_con, "SELECT * FROM services where Sno='$id'");
    ...
    <div id="wrapper-container" class="site-wrapper-container">
        ...
        <div id="main-content" class="site-main-content">
            <section class="site-content-area">
                ...
                <div class="uni-blog-grid-body" style="padding-bottom: 50px; padding-top: 30px;">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
