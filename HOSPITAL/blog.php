...
<!-- 05_02_blog_grid.html  [XR&CO'2014], Tue, 22 Oct 2019 11:55:53 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="uni-blog-grid-left">
                                    ...
                                    <div class="grid row">
                            <?php
                                $blog = mysqli_query($sql_con, "SELECT * FROM blog where RegistrationId='REGN000050'");
                                while($rod = mysqli_fetch_array($blog))
                                {
                                    ...
                                    $image = $rod['Image'];
                                        ...
                                        <span class="readmore"><a href="blog-detail.php?id=<?php echo $sno; ?>&user6=<?php echo $user; ?>&name=<?php echo $name; ?>">[ Read More ]</a></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
