...
<!-- 04_01_departments.html  [XR&CO'2014], Tue, 22 Oct 2019 11:55:26 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport"
    ...
    <div id="wrapper-container" class="site-wrapper-container">
        ...
        <div id="main-content" class="site-main-content">
            <section class="site-content-area">
                ...
                <div class="uni-departments-body" style="padding-top: 60px;">
                    <div class="container">
                        <div class="row">
                            <?php
                            $doct = mysqli_query($sql_con, "SELECT * FROM department where RegistrationId='$user'");
                             while($rode = mysqli_fetch_array($doct))
                                ...
                                ?>
                            <div class="col-md-4">
                                <div class="uni-departments-default" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;">
                                    <div class="item-icons" style="width: 50px; height: 50px;">
                                        
                                    </div>
                                    <div class="item-caption" style="padding-left: 10px; padding-right: 10px; padding-top: 30px;">
                                        <h4><a href="#"><?php echo $names; ?></a></h4>
                                        <p class="text-sm" style="color: black; text-align: justify; margin-bottom: 10px;"><?php echo $design; ?></p>
                                        <a href="department-detail.php?id=<?php echo $sn; ?>&user6=<?php echo $user; ?>&name=<?php echo $name; ?>" style="font-size: 14px;">Reading Continue</a>
                                    </div>
                                </div>
                            </div>
                            <?php
                            ...
                            <div class="footer-main-content-element col-md-3 col-sm-6">
                                <aside class="widget">
                                    ...
                                    <div class="widget-content">
                                        ...
                                        ?>
                                               <li><a href="#"><span>+</span> <?php echo $dep; ?></a></li>
                                                <?php
                                        }
                                        ?>
                                            </ul>
